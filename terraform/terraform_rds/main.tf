...
resource "aws_db_subnet_group" "power_monitor_subnet_group" {
  ...
  subnet_ids = ["subnet-0c47ef6fc81ba084a", "subnet-0c2e92c1b7b782543"]
...
resource "aws_security_group" "rds_sg" {
  ...
  vpc_id      = "vpc-01b7a51a09d27de04"  # Added VPC ID
...
resource "aws_db_instance" "c20_power_monitor_db" {
  ...
  db_subnet_group_name   = aws_db_subnet_group.power_monitor_subnet_group.name  # Added
