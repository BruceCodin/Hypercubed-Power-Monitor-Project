...
@patch('extract_cuts_from_rds.boto3.client')
...
@patch('extract_cuts_from_rds.os.environ', {})
...
@patch('extract_cuts_from_rds.psycopg2.connect')
...
@patch('extract_cuts_from_rds.get_secrets')
@patch('extract_cuts_from_rds.connect_to_database')
