...
def lambda_handler(event, context):
    ...
    try:
        ...
        # Import both handlers (imports here to ensure path setup completes first)
        ...
        # Broad exception needed here to ensure Lambda doesn't crash on any pipeline error
